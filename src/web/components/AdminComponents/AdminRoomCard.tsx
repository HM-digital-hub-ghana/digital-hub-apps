...
export default function AdminRoomCard({ data, onBookRoom }: CardProps) {
  const {
    image,
    status,
    conferenceRoomName,
  ...
  return (
    <div className="py-6">
      <div className="flex items-center  gap-6">
        ...
        {/* down */}
        <div className="p-3 rounded-xl border  border-gray-200 overflow-hidden bg-white  shadow-[0_1px_2px_-1px_#0000001A]">
          <div className="py-3">
    ...
    ${
      status === "available"
        ? "bg-[#00DD390D] border-[#00DD3933]" // green tone
        : "bg-[#DC26260D] border-[#DC262633]" // red tone
    }`}
          >
            <p
              className={`font-bold ${
